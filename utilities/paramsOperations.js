...
const po_BDS = [
    ...
    { p: 'sTenTinh', o: 'LIKE', a: 'sp', sbi: true }, // Select and Post for sTenTinh
    { p: 'iID_MaTinh', o: 'IN', a: 'pdc', sbi: true }, // Post, Delete, and Condition for iID_MaTinh
    { p: 'sTenQuan', o: 'LIKE', a: 's', sbi: true }, // Select for sTenQuan
    { p: 'iID_MaQuan', o: 'IN', a: 'pdc', sbi: true }, // Post, Delete, and Condition for iID_MaQuan
    { p: 'sTenPhuongXa', o: 'LIKE', a: 's', sbi: true }, // Select for sTenPhuongXa
    { p: 'iID_MaPhuongXa', o: 'IN', a: 's', sbi: true }, // Select for iID_MaPhuongXa
    { p: 'sTenDuong', o: 'LIKE', a: 's', sbi: true }, // Select for sTenDuong
    ...
    { p: 'sHuongNha', o: 'LIKE', a: 's', sbi: true }, // Select for sHuongNha
    ...
    { p: 'sMoTa', o: 'LIKE', a: 's', sbi: true }, // Select for sMoTa
    { p: 'sFiles', o: 'LIKE', a: 's', sbi: true }, // Select for sFiles
    { p: 'sAvatar', o: 'LIKE', a: 'sp', sbi: false }, // Select and Post for sAvatar
    { p: 'sLat', o: 'LIKE', a: 's', sbi: true }, // Select for sLat
    { p: 'sLng', o: 'LIKE', a: 's', sbi: true }, // Select for sLng
