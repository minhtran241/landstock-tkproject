...
const po_HinhAnh = [
    ...
    { p: 'iID_HinhAnh', t: 'number', o: 'IN', a: 'spci', clht: 'UInt64' },
...
const po_BDS = [
    ...
    { p: 'iID_MaTinh', t: 'number', o: 'IN', a: 'spci', clht: 'UInt64' },
    { p: 'sTenQuan', t: 'string', o: 'LIKE', a: 'spi', clht: 'String' },
    { p: 'iID_MaQuan', t: 'number', o: 'IN', a: 'spci', clht: 'UInt64' },
    { p: 'sTenPhuongXa', t: 'string', o: 'LIKE', a: 'pi', clht: 'String' },
    { p: 'iID_MaPhuongXa', t: 'number', o: 'IN', a: 'pci', clht: 'UInt64' },
    { p: 'sTenDuong', t: 'string', o: 'LIKE', a: 'pi', clht: 'String' },
    { p: 'sLoaiHang', t: 'string', o: 'LIKEAND', a: 'pci', clht: 'String' },
    { p: 'iDienTich', t: 'number', o: 'BETWEEN', a: 'spci', clht: 'UInt64' },
    { p: 'iSoTang', t: 'number', o: 'BETWEEN', a: 'spci', clht: 'UInt64' },
    { p: 'iMatTien', t: 'number', o: 'BETWEEN', a: 'pci', clht: 'UInt64' },
    {
        p: 'iGiaChaoHopDong',
        t: 'number',
        o: 'BETWEEN',
    ...
    { p: 'iID_HuongNha', t: 'number', o: 'IN', a: 'pci', clht: 'UInt64' },
    { p: 'iSoPhongNgu', t: 'number', o: 'IN', a: 'pci', clht: 'UInt64' },
    { p: 'iSoToilet', t: 'number', o: 'IN', a: 'pci', clht: 'UInt64' },
    ...
    { p: 'sHotline', t: 'string', o: 'IN', a: 'spi', clht: 'String' },
    { p: 'dNgayTao', t: 'date', o: 'BETWEEN', a: '', clht: 'DateTime' },
...
const po_KhachHang = [
    ...
    { p: 'iTrangThai', t: 'number', o: 'IN', a: 'spci', clht: 'String' },
